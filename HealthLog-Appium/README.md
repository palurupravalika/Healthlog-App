...
This directory contains the completely isolated E2E testing framework for the HealthLog Android application.

## Overview
- **Total Test Cases**: 500 Android E2E Tests
- **Categories**: 10 distinct test suites (50 tests per category)
- **Execution Mode**: Autonomous Node.js Test Runner (Automated E2E Mobile Execution)
- **Reporting Engine**:
  ...
  - `screenshots/` (Execution PNG assets)
